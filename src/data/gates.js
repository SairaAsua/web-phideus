export const gates = [
    ...
    { id: 'gate-4-4', name: 'Gate 4.4', title: 'Third Tower + FiLM + MoE', status: 'CLOSED', decision: 'Screening complete', s: '83.6%', description: '24 arms screened (incl. MoE v2/v3/v4). Third Tower (t3-wt) wins 4.4 family. Runs largos: d4a4=83.6%, a4r=82.0%, d4-a4r/t3-wt=79.8%.', source: 'Documents/01_FRENTES_ACTIVOS/BIAS_CONTROL/08_GATE_4_4_ARQUITECTURAS_MAYORES/README.md' },
    { id: 'gate-5a', name: 'Gate 5A', title: 'Descriptor × Mechanism Sweep', status: 'PENDING', decision: 'In Prep', s: null, source: 'Documents/01_FRENTES_ACTIVOS/BIAS_CONTROL/09_GATE_5_LINEA_A_BARRIDO/README.md' },
