export const hypotheses = [
  ...
  },
  {
    id: 'H2',
    name: 'Learnability',
    statement: 'Neural networks can learn compact representations of ratio distributions.',
    status: 'VALIDATED',
    evidence: 'val_loss < 0.5 with temporal representations (v5.0).',
    source: 'Documents/04_TRANSVERSAL/TEORIA_Y_FUNDAMENTOS/PHIDEUS_MASTER_BRIEFING.md §1'
  },
  {
    id: 'H3',
    name: 'Cross-modality',
    statement: 'Different signal domains share ratio structure that enables cross-modal retrieval.',
    status: 'UNDER_INVESTIGATION',
    evidence: 'Gate 4.3: d4a4=69.8% (+9.6pp). Scratch 30ep: d4a4=83.6% (+21.8pp). Gate 4.4: 24 arms screened.',
    source: 'README.md, Documents/01_FRENTES_ACTIVOS/BIAS_CONTROL/ROADMAP_BIAS_CONTROL.md §7.11'
  }
];
